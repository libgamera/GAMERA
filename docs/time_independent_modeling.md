...
```
>Note 1: 
>There is a [dedicated tutorial](/docs/inverse_compton) on how to set radiation fields for the IC process.
 
>Note 2:
>Environmental parameters determine the cooling rate of electrons. Check [this tutorial](/docs/energy_loss) on how to visualise this information.
...
[Here](/docs/particle_escape) you can learn how to do this. The easies case, a constant
...
equation (for more infos, see [here](/docs/documentation) with the following command:
